...
export default function RestaurantLayout() {
  ...
  useEffect(() => {
    // Only intercept when on the Restaurant Home page
    const isAtRoot = location.pathname === "/restaurant" || location.pathname === "/restaurant/"
  ...
  const handleConfirmLogout = async () => {
    ...
    try {
      ...
      try {
        let fcmToken = localStorage.getItem("fcm_web_registered_token_restaurant") || null
