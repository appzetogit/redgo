...
const CookingAnimation = memo(() => (
  <div className="relative w-12 h-12 flex items-center justify-center rounded-xl bg-red-50 border border-red-100 overflow-visible shadow-[0_4px_15px_rgba(235,89,14,0.15)] shrink-0">
    ...
    <motion.div animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="relative z-10 mt-1">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500 drop-shadow-sm">
        {/* Cooker Body */}
    ...
    <AnimatePresence>
      ...
      >
        <div 
          ...
          className="relative bg-white/95 backdrop-blur-xl rounded-[20px] p-4 shadow-[0_8px_30px_rgba(235,89,14,0.15)] border border-red-100/60 overflow-visible cursor-pointer group"
        >
          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="flex-1 min-w-0 pr-4">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <ChevronRight className="w-3.5 h-3.5 text-red-500 shrink-0 group-hover:translate-x-1 transition-transform" />
              </div>
            </div>

            <div className="bg-gradient-to-br from-[#E23744] to-[#C21824] shadow-lg shadow-red-500/20 rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border border-red-200">
              <p className="text-red-50 text-[10px] font-bold uppercase tracking-wider opacity-95 leading-tight mb-[2px]">
                arriving in
              </p>
