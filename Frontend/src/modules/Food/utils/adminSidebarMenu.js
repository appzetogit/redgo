export const adminSidebarMenu = [
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Restaurant Reviews", path: "/admin/restaurants/reviews" },
  ...
  },
  {
    ...
    items: [
      { type: "link", label: "Referral Settings", path: "/admin/referral-settings", icon: "Gift" },
    ],
  },
  {
    type: "section",
  ...
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Delivery Boy Commission", path: "/admin/delivery-boy-commission", icon: "DollarSign" },
      { type: "link", label: "Delivery Emergency Help", path: "/admin/delivery-emergency-help", icon: "Phone" },
      { type: "link", label: "Delivery Support Tickets", path: "/admin/delivery-support-tickets", icon: "MessageSquare" },
      {
        type: "expandable",
        label: "Deliveryman",
        icon: "Package",
  ...
  },
  {
    ...
    label: "HELP & SUPPORT",
    items: [
      { type: "link", label: "User Feedback", path: "/admin/contact-messages", icon: "Mail" },
      { type: "link", label: "Safety Emergency Reports", path: "/admin/safety-emergency-reports", icon: "AlertTriangle" },
    ],
  },
  {
    type: "section",
    ...
    items: [
      ...
      { type: "link", label: "Order Report", path: "/admin/order-report/regular", icon: "FileText" },
      { type: "link", label: "Tax Report", path: "/admin/tax-report", icon: "Receipt" },
      {
        type: "expandable",
        label: "Restaurant Report",
        icon: "FileText",
        subItems: [{ label: "Restaurant Report", path: "/admin/restaurant-report" }],
      },
      {
        type: "expandable",
        label: "Customer Report",
        icon: "FileText",
        subItems: [{ label: "Feedback Experience", path: "/admin/customer-report/feedback-experience" }],
      },
    ],
  },
  {
    ...
    items: [
      { type: "link", label: "Restaurant Withdraws", path: "/admin/restaurant-withdraws", icon: "CreditCard" },
    ],
  },
  {
    type: "section",
  ...
  },
  {
    ...
    items: [
      { type: "link", label: "Dining Banners", path: "/admin/dining-management", icon: "UtensilsCrossed" },
      { type: "link", label: "Dining List", path: "/admin/dining-list", icon: "FileText" },
    ],
  },
  {
    type: "section",
  ...
  },
  {
    ...
    items: [
      { type: "link", label: "About Us", path: "/admin/pages-social-media/about", icon: "Globe" },
      { type: "link", label: "Terms & Conditions", path: "/admin/pages-social-media/terms", icon: "FileText" },
      { type: "link", label: "Privacy Policy", path: "/admin/pages-social-media/privacy", icon: "Lock" },
      { type: "link", label: "Refund Policy", path: "/admin/pages-social-media/refund", icon: "Receipt" },
      { type: "link", label: "Shipping Policy", path: "/admin/pages-social-media/shipping", icon: "Truck" },
      { type: "link", label: "Cancellation Policy", path: "/admin/pages-social-media/cancellation", icon: "X" },
    ],
  },
];
