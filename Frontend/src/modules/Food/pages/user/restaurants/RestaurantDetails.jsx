    ...
    >
              ...
              <div className="flex items-center gap-2 flex-1 max-w-md">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2 rounded-full border border-gray-200 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a] text-sm dark:text-white focus:outline-none focus:ring-2 focus:ring-[#E23744] focus:border-transparent"
                    autoFocus
                    onBlur={() => {
                      if (!searchQuery) {
                        setShowSearch(false)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-4 sm:py-5 md:py-6 lg:py-8 space-y-3 md:space-y-4 lg:space-y-5 pb-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm overflow-hidden">
              <Tag className="h-4 w-4 text-[#E23744]" />
              <div className="relative h-5 overflow-hidden">
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="text-[#E23744] font-medium inline-block"
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 whitespace-nowrap rounded-full border px-3 py-1.5 text-sm font-semibold transition-colors ${
                      selectedMenuCategory === "all"
                        ? "border-[#E23744] bg-[#FFF1E8] text-[#E23744]"
                      ...
                      {sectionItems.map((item) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex gap-4 p-4 relative cursor-pointer transition-all duration-500 ease-out 
                              ${highlightedDishId === item.id
                                ? "bg-white dark:bg-[#1a1a1a] rounded-[22px] mx-2 my-3 border-2 border-[#E23744] shadow-[0_20px_50px_-12px_rgba(226,55,68,0.4)] scale-[1.02] z-10 ring-8 ring-[#E23744]/5"
                                : "border-b border-gray-50 dark:border-gray-800/50 last:border-none"
                              }`}
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mb-1">
                                {isVeg ? (
                                  <div className="w-4 h-4 border-2 border-green-600 bg-white flex items-center justify-center rounded flex-shrink-0 p-[2px]">
                                    <div className="w-full h-full bg-green-600 rounded-full"></div>
                                  </div>
                                ) : (
                                  <div className="w-4 h-4 border-2 border-red-600 bg-white flex items-center justify-center rounded flex-shrink-0 p-[2px]">
                              ...
                              {quantity > 0 ? (
                                ...
                                >
                                  <button
                                    ...
                                    className={shouldShowGrayscale ? 'text-gray-400 cursor-not-allowed' : 'text-[#E23744] hover:text-[#D94F0C]'}
                                  >
                                    <Minus size={14} />
                                  </button>
      ...
      {!showFilterSheet && !showMenuSheet && !showMenuOptionsSheet && (
        <div className="sticky dark:bg-[#1a1a1a] bottom-4 flex justify-end px-4 z-50 mt-auto">
          <Button
            className="bg-[#1a1a1a] dark:bg-[#E23744] hover:bg-black dark:hover:bg-[#D94F0C] text-white flex items-center gap-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/10 dark:border-[#E23744]/20 px-6 py-6 rounded-full font-bold transform transition-all duration-300 hover:scale-110 active:scale-95 group"
            size="lg"
            onClick={() => setShowMenuSheet(true)}
          >
            <Utensils className="h-5 w-5 text-[#E23744] dark:text-white group-hover:rotate-12 transition-transform" />
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4 bg-white dark:bg-[#1a1a1a]">
                    <Button
                      className="w-full bg-[#1a1a1a] dark:bg-[#E23744] hover:bg-[#E23744] dark:hover:bg-[#D94F0C] text-white border-0 flex items-center justify-center gap-2 py-6 rounded-xl font-bold transition-all shadow-lg"
                      onClick={() => setShowMenuSheet(false)}
                    >
                      <X className="h-5 w-5" />
                      Close
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center justify-between bg-white dark:bg-[#1a1a1a]">
                    ...
                    <Button
                      className="bg-[#E23744] hover:bg-[#D94F0C] text-white px-6 py-2.5 rounded-lg font-bold"
                      onClick={() => setShowFilterSheet(false)}
                    >
                    ...
                    {restaurant?.outlets && Array.isArray(restaurant.outlets) && restaurant.outlets.length > 0 ? (
                      <div className="space-y-2">
                        {restaurant.outlets.map((outlet) => (
                          ...
                          >
                            {outlet?.isNearest && (
                              <div className="flex items-center gap-1.5 mb-2 px-2 py-1 bg-[#FFF2EB] dark:bg-[#E23744]/20 rounded-md">
                                <Zap className="h-3.5 w-3.5 text-[#E23744] dark:text-[#E23744] fill-[#E23744] dark:fill-[#E23744]" />
                                <span className="text-xs font-semibold text-[#E23744] dark:text-[#E23744]">
              ...
              <>
                ...
                >
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-800 px-4 py-4">
                    <Button
                      className="w-full bg-[#E23744] hover:bg-[#D94F0C] text-white py-3 rounded-lg font-bold"
                      onClick={() => {
                        setShowManageCollections(false)
                      }}
                    >
