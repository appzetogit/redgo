...
const schema = z.object({
    name: z.string().trim().min(3, "Name must be at least 3 characters").max(25, "Name must be at most 25 characters").regex(/^[A-Za-z\s]+$/, "Name must contain only alphabets and spaces").optional(),
